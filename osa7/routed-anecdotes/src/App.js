...
const CreateNew = ({ addNew }) => {
  ...
  const {reset: reset1, ...inputContent} = content
  const {reset: reset2, ...inputAuthor} = author
  const {reset: reset3, ...inputInfo} = info
...
// buttonit inputeiks!! input type= submit value "submit"
  return (
    <div>
...
const App = () => {
  ...
  return (
    <div>
      ...
      <Switch>
        <Route path='/anecdotes/:id'><Anecdote anecdote={anecdote}></Anecdote></Route>
        <Route path='/create'><CreateNew addNew={addNew}></CreateNew></Route>
        <Route path='/about'><About></About></Route>
        <Route path='/'> <AnecdoteList anecdotes={anecdotes} notification={notification}></AnecdoteList></Route>
